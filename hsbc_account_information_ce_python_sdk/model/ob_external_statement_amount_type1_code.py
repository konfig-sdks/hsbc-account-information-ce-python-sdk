...
class OBExternalStatementAmountType1Code(
    ...
    class MetaOapg:
        enum_value_to_name = {
            "UK.OBIE.ArrearsClosingBalance": "ARREARS_CLOSING_BALANCE",
            "UK.OBIE.AvailableBalance": "AVAILABLE_BALANCE",
            "UK.OBIE.AverageBalanceWhenInCredit": "AVERAGE_BALANCE_WHEN_IN_CREDIT",
            "UK.OBIE.AverageBalanceWhenInDebit": "AVERAGE_BALANCE_WHEN_IN_DEBIT",
            "UK.OBIE.AverageDailyBalance": "AVERAGE_DAILY_BALANCE",
            "UK.OBIE.BalanceTransferClosingBalance": "BALANCE_TRANSFER_CLOSING_BALANCE",
            "UK.OBIE.CashClosingBalance": "CASH_CLOSING_BALANCE",
            "UK.OBIE.ClosingBalance": "CLOSING_BALANCE",
            "UK.OBIE.CreditLimit": "CREDIT_LIMIT",
            "UK.OBIE.CurrentPayment": "CURRENT_PAYMENT",
            "UK.OBIE.DirectDebitPaymentDue": "DIRECT_DEBIT_PAYMENT_DUE",
            "UK.OBIE.FSCSInsurance": "FSCSINSURANCE",
            "UK.OBIE.MinimumPaymentDue": "MINIMUM_PAYMENT_DUE",
            "UK.OBIE.PendingTransactionsBalance": "PENDING_TRANSACTIONS_BALANCE",
            "UK.OBIE.PreviousClosingBalance": "PREVIOUS_CLOSING_BALANCE",
            "UK.OBIE.PreviousPayment": "PREVIOUS_PAYMENT",
            "UK.OBIE.PurchaseClosingBalance": "PURCHASE_CLOSING_BALANCE",
            "UK.OBIE.StartingBalance": "STARTING_BALANCE",
            "UK.OBIE.TotalAdjustments": "TOTAL_ADJUSTMENTS",
            "UK.OBIE.TotalCashAdvances": "TOTAL_CASH_ADVANCES",
            "UK.OBIE.TotalCharges": "TOTAL_CHARGES",
            "UK.OBIE.TotalCredits": "TOTAL_CREDITS",
            "UK.OBIE.TotalDebits": "TOTAL_DEBITS",
            "UK.OBIE.TotalPurchases": "TOTAL_PURCHASES",
        }
