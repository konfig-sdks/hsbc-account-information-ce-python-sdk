...
class OBStandingOrder6Detail(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AccountId", "Frequency", "CreditorAccount", "StandingOrderId", "Reference", "FirstPaymentDateTime", "NextPaymentDateTime", "LastPaymentDateTime", "FinalPaymentDateTime", "NumberOfPayments", "StandingOrderStatusCode", "FirstPaymentAmount", "NextPaymentAmount", "LastPaymentAmount", "FinalPaymentAmount", "CreditorAgent", "SupplementaryData", ], str]):
