...
class OBStatement2Basic(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AccountId", "Type", "StartDateTime", "EndDateTime", "CreationDateTime", "StatementId", "StatementReference", "StatementDescription", "StatementBenefit", "StatementFee", "StatementInterest", "StatementDateTime", "StatementRate", "StatementValue", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["AccountId", "Type", "StartDateTime", "EndDateTime", "CreationDateTime", "StatementId", "StatementReference", "StatementDescription", "StatementBenefit", "StatementFee", "StatementInterest", "StatementDateTime", "StatementRate", "StatementValue", ], str]):
