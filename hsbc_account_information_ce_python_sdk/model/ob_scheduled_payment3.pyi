...
class OBScheduledPayment3(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def CreditorAgent() -> typing.Type['OBBranchAndFinancialInstitutionIdentification51']:
                return OBBranchAndFinancialInstitutionIdentification51
        
            @staticmethod
            def CreditorAccount() -> typing.Type['OBCashAccount51']:
                return OBCashAccount51
            __annotations__ = {
                "AccountId": AccountId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["CreditorAgent"]) -> 'OBBranchAndFinancialInstitutionIdentification51': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["CreditorAccount"]) -> 'OBCashAccount51': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AccountId", "ScheduledPaymentDateTime", "ScheduledType", "InstructedAmount", "ScheduledPaymentId", "Reference", "DebtorReference", "CreditorAgent", "CreditorAccount", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CreditorAgent"]) -> typing.Union['OBBranchAndFinancialInstitutionIdentification51', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CreditorAccount"]) -> typing.Union['OBCashAccount51', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["AccountId", "ScheduledPaymentDateTime", "ScheduledType", "InstructedAmount", "ScheduledPaymentId", "Reference", "DebtorReference", "CreditorAgent", "CreditorAccount", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        CreditorAgent: typing.Union['OBBranchAndFinancialInstitutionIdentification51', schemas.Unset] = schemas.unset,
        CreditorAccount: typing.Union['OBCashAccount51', schemas.Unset] = schemas.unset,
