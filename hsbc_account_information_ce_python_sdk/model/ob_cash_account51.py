...
class OBCashAccount51(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def SchemeName() -> typing.Type['OBExternalAccountIdentification4Code']:
    ...
    Identification: MetaOapg.properties.Identification
    SchemeName: 'OBExternalAccountIdentification4Code'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["SchemeName"]) -> 'OBExternalAccountIdentification4Code': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["SchemeName"]) -> 'OBExternalAccountIdentification4Code': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Identification"]) -> MetaOapg.properties.Identification: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        Identification: typing.Union[MetaOapg.properties.Identification, str, ],
        SchemeName: 'OBExternalAccountIdentification4Code',
