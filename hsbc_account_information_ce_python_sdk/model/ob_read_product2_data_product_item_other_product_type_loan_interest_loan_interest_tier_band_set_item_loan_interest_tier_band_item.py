...
class OBReadProduct2DataProductItemOtherProductTypeLoanInterestLoanInterestTierBandSetItemLoanInterestTierBandItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["TierValueMinimum", "TierValueMinTerm", "MinTermPeriod", "FixedVariableInterestRateType", "RepAPR", "Identification", "TierValueMaximum", "TierValueMaxTerm", "MaxTermPeriod", "LoanProviderInterestRateType", "LoanProviderInterestRate", "Notes", "OtherLoanProviderInterestRateType", "LoanInterestFeesCharges", ], str]):
