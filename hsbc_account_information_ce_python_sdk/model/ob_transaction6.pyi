...
class OBTransaction6(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AccountId", "CreditDebitIndicator", "Status", "BookingDateTime", "Amount", "TransactionId", "TransactionReference", "StatementReference", "TransactionMutability", "ValueDateTime", "TransactionInformation", "AddressLine", "ChargeAmount", "CurrencyExchange", "BankTransactionCode", "ProprietaryBankTransactionCode", "Balance", "MerchantDetails", "CreditorAgent", "CreditorAccount", "DebtorAgent", "DebtorAccount", "CardInstrument", "SupplementaryData", ], str]):
