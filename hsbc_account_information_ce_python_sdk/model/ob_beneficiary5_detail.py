...
class OBBeneficiary5Detail(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["CreditorAccount", "AccountId", "BeneficiaryId", "BeneficiaryType", "Reference", "SupplementaryData", "CreditorAgent", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CreditorAccount"]) -> 'OBCashAccount50': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["CreditorAccount", "AccountId", "BeneficiaryId", "BeneficiaryType", "Reference", "SupplementaryData", "CreditorAgent", ], str]):
