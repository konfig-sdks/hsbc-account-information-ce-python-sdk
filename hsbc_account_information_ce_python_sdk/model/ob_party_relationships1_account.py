...
class OBPartyRelationships1Account(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Related", "Id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Related", "Id", ], str]):
