...
class OBScheduledPayment3Basic(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AccountId", "ScheduledPaymentDateTime", "ScheduledType", "InstructedAmount", "ScheduledPaymentId", "Reference", "DebtorReference", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["AccountId", "ScheduledPaymentDateTime", "ScheduledType", "InstructedAmount", "ScheduledPaymentId", "Reference", "DebtorReference", ], str]):
