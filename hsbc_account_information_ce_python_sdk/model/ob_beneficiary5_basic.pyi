...
class OBBeneficiary5Basic(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AccountId", "BeneficiaryId", "BeneficiaryType", "Reference", "SupplementaryData", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["AccountId", "BeneficiaryId", "BeneficiaryType", "Reference", "SupplementaryData", ], str]):
