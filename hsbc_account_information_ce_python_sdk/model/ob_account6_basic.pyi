...
class OBAccount6Basic(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AccountId", "Currency", "AccountType", "AccountSubType", "Status", "StatusUpdateDateTime", "Description", "Nickname", "OpeningDate", "MaturityDate", "SwitchStatus", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["AccountId", "Currency", "AccountType", "AccountSubType", "Status", "StatusUpdateDateTime", "Description", "Nickname", "OpeningDate", "MaturityDate", "SwitchStatus", ], str]):
