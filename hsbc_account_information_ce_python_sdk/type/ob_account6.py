...
from hsbc_account_information_ce_python_sdk.type.ob_account6_account import OBAccount6Account
...
class RequiredOBAccount6(TypedDict):
    AccountId: AccountId

class OptionalOBAccount6(TypedDict, total=False):
...
class OBAccount6(RequiredOBAccount6, OptionalOBAccount6):
    pass
