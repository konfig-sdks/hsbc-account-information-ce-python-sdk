...
class RequiredOBTransaction6(TypedDict):
    AccountId: AccountId
...
class OptionalOBTransaction6(TypedDict, total=False):
...
class OBTransaction6(RequiredOBTransaction6, OptionalOBTransaction6):
    pass
