...
class RequiredOBStatement2DetailStatementFeeItem(TypedDict):
...
class OptionalOBStatement2DetailStatementFeeItem(TypedDict, total=False):
...
class OBStatement2DetailStatementFeeItem(RequiredOBStatement2DetailStatementFeeItem, OptionalOBStatement2DetailStatementFeeItem):
    pass
