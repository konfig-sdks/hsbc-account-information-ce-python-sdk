...
from hsbc_account_information_ce_python_sdk.model.ob_read_account6 import OBReadAccount6 as OBReadAccount6Schema
from hsbc_account_information_ce_python_sdk.model.ob_error_response1 import OBErrorResponse1 as OBErrorResponse1Schema

from hsbc_account_information_ce_python_sdk.type.ob_read_account6 import OBReadAccount6
from hsbc_account_information_ce_python_sdk.type.ob_error_response1 import OBErrorResponse1

from ...api_client import Dictionary
from hsbc_account_information_ce_python_sdk.pydantic.ob_read_account6 import OBReadAccount6 as OBReadAccount6Pydantic
...
XFapiInteractionIdSchema = schemas.StrSchema
SchemaFor200ResponseBodyApplicationJson = OBReadAccount6Schema
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = OBReadAccount6Schema
SchemaFor200ResponseBodyApplicationJosejwe = OBReadAccount6Schema
...
class BaseApi(api_client.Api):
    ...
    def _get_balances_by_account_id_mapped_args(
        self,
        account_id: str,
    ...
    async def _aget_balances_by_account_id_oapg(
        self,
    ...
    def _get_balances_by_account_id_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetBalancesByAccountIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_balances_by_account_id(
        self,
        account_id: str,
        x_fapi_auth_date: typing.Optional[str] = None,
        x_fapi_customer_ip_address: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_balances_by_account_id_mapped_args(
        ...
        return await self._aget_balances_by_account_id_oapg(
    ...
    def get_balances_by_account_id(
        ...
        return self._get_balances_by_account_id_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetBalancesByAccountId(BaseApi):
    ...
    async def aget_balances_by_account_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OBReadAccount6Pydantic:
        raw_response = await self.raw.aget_balances_by_account_id(
            account_id=account_id,
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
            x_fapi_interaction_id=x_fapi_interaction_id,
        ...
        if validate:
            return OBReadAccount6Pydantic(**raw_response.body)
        return api_client.construct_model_instance(OBReadAccount6Pydantic, raw_response.body)
    ...
    def get_balances_by_account_id(
        ...
        raw_response = self.raw.get_balances_by_account_id(
            account_id=account_id,
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
            x_fapi_interaction_id=x_fapi_interaction_id,
