...
from hsbc_account_information_ce_python_sdk.request_before_hook import request_before_hook
import json
from urllib3._collections import HTTPHeaderDict

from hsbc_account_information_ce_python_sdk.api_response import AsyncGeneratorResponse
from hsbc_account_information_ce_python_sdk import api_client, exceptions
...
from hsbc_account_information_ce_python_sdk.model.ob_read_consent1 import OBReadConsent1 as OBReadConsent1Schema
from hsbc_account_information_ce_python_sdk.model.ob_read_consent1_data import OBReadConsent1Data as OBReadConsent1DataSchema
from hsbc_account_information_ce_python_sdk.model.ob_error_response1 import OBErrorResponse1 as OBErrorResponse1Schema
from hsbc_account_information_ce_python_sdk.model.ob_read_consent_response1 import OBReadConsentResponse1 as OBReadConsentResponse1Schema

from hsbc_account_information_ce_python_sdk.type.ob_read_consent1 import OBReadConsent1
from hsbc_account_information_ce_python_sdk.type.ob_read_consent_response1 import OBReadConsentResponse1
from hsbc_account_information_ce_python_sdk.type.ob_error_response1 import OBErrorResponse1
from hsbc_account_information_ce_python_sdk.type.ob_read_consent1_data import OBReadConsent1Data

from ...api_client import Dictionary
from hsbc_account_information_ce_python_sdk.pydantic.ob_read_consent_response1 import OBReadConsentResponse1 as OBReadConsentResponse1Pydantic
from hsbc_account_information_ce_python_sdk.pydantic.ob_read_consent1_data import OBReadConsent1Data as OBReadConsent1DataPydantic
from hsbc_account_information_ce_python_sdk.pydantic.ob_error_response1 import OBErrorResponse1 as OBErrorResponse1Pydantic
from hsbc_account_information_ce_python_sdk.pydantic.ob_read_consent1 import OBReadConsent1 as OBReadConsent1Pydantic
...
# body param
SchemaForRequestBodyApplicationJson = OBReadConsent1Schema
SchemaForRequestBodyApplicationJsonCharsetutf8 = OBReadConsent1Schema
SchemaForRequestBodyApplicationJosejwe = OBReadConsent1Schema


request_body_ob_read_consent1 = api_client.RequestBody(
    content={
        ...
        'application/jose+jwe': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJosejwe),
    },
    required=True,
)
_auth = [
...
SchemaFor201ResponseBodyApplicationJson = OBReadConsentResponse1Schema
SchemaFor201ResponseBodyApplicationJsonCharsetutf8 = OBReadConsentResponse1Schema
SchemaFor201ResponseBodyApplicationJosejwe = OBReadConsentResponse1Schema
...
_response_for_201 = api_client.OpenApiResponse(
    ...
    content={
        ...
        'application/jose+jwe': api_client.MediaType(
            schema=SchemaFor201ResponseBodyApplicationJosejwe),
    },
    headers=[
...
ResponseHeadersFor415 = typing_extensions.TypedDict(
    'ResponseHeadersFor415',
    {
        'x-fapi-interaction-id': XFapiInteractionIdSchema,
    }
)
...
class BaseApi(api_client.Api):
    ...
    def _create_consent_mapped_args(
        self,
    ...
    async def _acreate_consent_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/account-access-consents',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_ob_read_consent1.serialize(body, content_type)
...
class CreateConsentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_consent(
        self,
        data: OBReadConsent1Data,
        risk: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]],
        x_fapi_auth_date: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_consent_mapped_args(
            data=data,
            risk=risk,
        ...
        return await self._acreate_consent_oapg(
            body=args.body,
    ...
    def create_consent(
        ...
        return self._create_consent_oapg(
            body=args.body,
            header_params=args.header,
        )

class CreateConsent(BaseApi):
    ...
    async def acreate_consent(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OBReadConsentResponse1Pydantic:
        raw_response = await self.raw.acreate_consent(
            data=data,
            risk=risk,
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
        ...
        if validate:
            return OBReadConsentResponse1Pydantic(**raw_response.body)
        return api_client.construct_model_instance(OBReadConsentResponse1Pydantic, raw_response.body)
    ...
    def create_consent(
        ...
        raw_response = self.raw.create_consent(
            data=data,
            risk=risk,
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
