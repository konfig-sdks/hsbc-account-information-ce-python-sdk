...
# Path params
ConsentIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'ConsentId': typing.Union[ConsentIdSchema, str, ],
    }
)
...
request_path_consent_id = api_client.PathParameter(
    name="ConsentId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ConsentIdSchema,
    required=True,
)
_auth = [
    'BearerAuth',
...
SchemaFor200ResponseBodyApplicationJson = OBReadConsentResponse1Schema
SchemaFor200ResponseBodyApplicationJsonCharsetutf8 = OBReadConsentResponse1Schema
SchemaFor200ResponseBodyApplicationJosejwe = OBReadConsentResponse1Schema
...
class BaseApi(api_client.Api):
    ...
    def _get_by_consent_id_mapped_args(
        self,
        consent_id: str,
    ...
    async def _aget_by_consent_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/account-access-consents/{ConsentId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetByConsentIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_consent_id(
        self,
        consent_id: str,
        x_fapi_auth_date: typing.Optional[str] = None,
        x_fapi_customer_ip_address: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_by_consent_id_mapped_args(
        ...
        return await self._aget_by_consent_id_oapg(
    ...
    def get_by_consent_id(
        ...
        return self._get_by_consent_id_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetByConsentId(BaseApi):
    ...
    async def aget_by_consent_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_consent_id(
            consent_id=consent_id,
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
            x_fapi_interaction_id=x_fapi_interaction_id,
    ...
    def get_by_consent_id(
        ...
        raw_response = self.raw.get_by_consent_id(
            consent_id=consent_id,
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
            x_fapi_interaction_id=x_fapi_interaction_id,
