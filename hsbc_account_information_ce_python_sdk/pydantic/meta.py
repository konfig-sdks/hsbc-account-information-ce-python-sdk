...
class Meta(BaseModel):
    ...
    first_available_date_time: typing.Optional[datetime] = Field(None, alias='FirstAvailableDateTime')

    # All dates in the JSON payloads are represented in ISO 8601 date-time format.  All date-time fields in responses must include the timezone. An example is below: 2017-04-05T10:43:07+00:00
    last_available_date_time: typing.Optional[datetime] = Field(None, alias='LastAvailableDateTime')
    class Config:
