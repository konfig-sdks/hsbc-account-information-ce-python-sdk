...
from hsbc_account_information_ce_python_sdk.pydantic.ob_account6_account import OBAccount6Account
...
class OBAccount6(BaseModel):
    ...
    currency: typing.Optional[ActiveOrHistoricCurrencyCode0] = Field(None, alias='Currency')

    account_type: typing.Optional[OBExternalAccountType1Code] = Field(None, alias='AccountType')

    account_sub_type: typing.Optional[OBExternalAccountSubType1Code] = Field(None, alias='AccountSubType')
    ...
    account: typing.Optional[OBAccount6Account] = Field(None, alias='Account')
